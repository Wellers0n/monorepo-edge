...
describe('Register', () => {
  ...
  it('should render require confirm password invalid', async () => {
    ...
    expect(screen.getByText('Suas senhas não correspondem')).toBeInTheDocument()
  })
  ...
  it('should render success message when register', async () => {
    ...
    fireEvent.change(phoneInput, { target: { value: '21987645347' } })
    fireEvent.change(companyNameInput, { target: { value: 'company admin' } })
  ...
  it('should render error message when register', async () => {
    ...
    expect(
      screen.getByText('Houve algum error ao registrar')
    ).toBeInTheDocument()
  })
})
